...
public class LEDSubsystem extends SubsystemBase {
  ...
  public LEDSubsystem() {
    ...
    onDisable(); // Start as disabled
  }

  public void onEnable() {
    setAll(LEDConstants.kDefaultColor);
  }

  public void onDisable() {
    setAll(LEDConstants.kDisableColor);
  }
  ...
  public void setBackAll(Color color) {
    for (
      var i = m_ledBuffer.getLength() / 2;
      i < m_ledBuffer.getLength();
      i++
    ) {
      m_ledBuffer.setLED(i, color);
    }
  ...
  public void setOne(int position, Color color) {
    m_ledBuffer.setLED(position, color);
    m_led.setData(m_ledBuffer);
  }
}
