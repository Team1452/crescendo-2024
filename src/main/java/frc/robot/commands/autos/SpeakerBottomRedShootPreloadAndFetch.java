...
public class SpeakerBottomRedShootPreloadAndFetch
  extends SequentialCommandGroup {

  public SpeakerBottomRedShootPreloadAndFetch(
    ...
    addCommands(
      new InstantCommand(() ->
        drivebase.resetOdometry(
          new Pose2d(new Translation2d(0.62, 4.19), Rotation2d.fromDegrees(60))
        )
      ),
      new AlignAndShoot(drivebase, shooterSubsystem, intakeIndexerSubsystem),
      new GoTo(
        new Pose2d(
          new Translation2d(-0.78, 3.94),
