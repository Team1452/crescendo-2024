...
public class RedShootPreloadAndFetch2 extends SequentialCommandGroup {

  public RedShootPreloadAndFetch2(
    ...
    addCommands(
      ...
      // Go for third note
      new GoTo(
        new Pose2d(new Translation2d(1.94, 4.02), Rotation2d.fromDegrees(0)),
        drivebase
      )
        .withTimeout(2.5),
      new InstantCommand(() -> System.out.println("Consume note")),
      ...
      /* Fourth note */
      new GoTo(
        new Pose2d(new Translation2d(1.94, 7.00), Rotation2d.fromDegrees(0)),
        drivebase
      )
        .withTimeout(2.5),
      new InstantCommand(() -> System.out.println("Consume note")),
      ...
      new GoTo(
        ...
        .withTimeout(2.5),
      new InstantCommand(() ->
        System.out.println("Align and shoot w/ fourth note")
      ),
      new AlignAndShoot(drivebase, shooterSubsystem, intakeIndexerSubsystem)
    );
